...
export default class SectionStats extends LightningElement {
    @api content = {};
    @api sectionStyle = {};
    ...
    get rootClass() {
        return sectionRootClass('sec_stats', {
    ...
    handleAdd() {
        addListItem(this, this.content?.items, { value: '99%', label: 'A number that matters' });
    }
    handleRemove(event) {
