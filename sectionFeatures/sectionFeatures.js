...
export default class SectionFeatures extends LightningElement {
    @api content = {};
    @api sectionStyle = {};
    @api variant = 'three-up';
    @api layout = {};
    @api mode = 'live';
    ...
    get rootClass() {
        return sectionRootClass('sec_features', {
    ...
    handleAdd() {
        addListItem(this, this.content?.items, { title: 'New pillar', body: 'Describe it.' });
    }
    handleRemove(event) {
